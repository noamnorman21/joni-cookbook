...
const RecipeDetail: React.FC = () => {
    ...
    return (
        <>
            <Header />
            <article className="recipe-page container section fade-in">
                <header className="recipe-header text-center">
                    <h1 className="recipe-title text-serif">{recipe.title}</h1>
                    <div className="recipe-meta">
                        <span>{recipe.category === 'starters' ? 'מנה ראשונה' : recipe.category === 'mains' ? 'מנה עיקרית' : 'קינוח'}</span>
                    </div>
                </header>
                    ...
                    <aside className="recipe-sidebar">
                        <div className="recipe-details-card">
                            ...
                            <div className="detail-item">
                                ...
                                <strong>קושי:</strong> {Array(recipe.difficulty).fill('★').join('')}
                            </div>
                        </div>
