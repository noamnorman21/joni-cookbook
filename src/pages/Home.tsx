...
import homeBg from "../assets/cover.png";
    ...
    <>
      ...
      <main>
        <section
          className="hero"
          style={{
            backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.5)), url(${homeBg})`,
          }}
        >
          <div className="hero-content fade-in">
            ...
            <p className="hero-text">
              ג׳וני אהב לאכול. באמת אהב. לא רק את הטעם, אלא את כל מה שמסביב:
              הריח במטבח, הסירים על האש, הצלחות שנערמות על השולחן, והשיחה
              שמתארכת בדיוק כשחותכים עוד פרוסה ועוד אחת.
              <br />
              באתר הזה אספנו את המתכונים של אלה, של המשפחה ושל האנשים שאהבו
              אותו, המתכונים שהוא ביקש שוב ושוב, אלה שחיכו לו בסופי שבוע ואלה
              שתמיד נעלמו ראשונים.
              <br />
        ...
        <section className="quote-section">
          ...
          <cite className="quote-author">- ג'וני</cite>
        </section>
